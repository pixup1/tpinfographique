...
HierarchicalRenderable::HierarchicalRenderable(ShaderProgramPtr shaderProgram) : Renderable(shaderProgram), m_parent(nullptr), m_globalTransform(glm::mat4(1.0)), m_localTransform(glm::mat4(1.0))
{
}
