...
ParticleListRenderable::ParticleListRenderable(ShaderProgramPtr program, std::vector<ParticlePtr>& particles, unsigned int strips, unsigned int slices) : HierarchicalRenderable(program),
