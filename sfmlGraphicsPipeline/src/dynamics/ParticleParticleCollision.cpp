...
ParticleParticleCollision::ParticleParticleCollision(ParticlePtr particle1, ParticlePtr particle2, float restitution) : Collision(restitution)
{
	m_p1 = particle1;
	m_p2 = particle2;
}
