...
ConstantForceFieldRenderable::ConstantForceFieldRenderable(ShaderProgramPtr shaderProgram, ConstantForceFieldPtr forceField) : MeshRenderable(shaderProgram, false),
