...
SpringForceFieldRenderable::SpringForceFieldRenderable(ShaderProgramPtr shaderProgram, SpringForceFieldPtr springForceField) : MeshRenderable(shaderProgram, false),
