...
LightedMeshRenderable::LightedMeshRenderable(ShaderProgramPtr shaderProgram,
                                             ...
                                             const MaterialPtr& material) : MeshRenderable(shaderProgram, positions, indices, normals, colors),
...
LightedMeshRenderable::LightedMeshRenderable(ShaderProgramPtr shaderProgram,
                                             ...
                                             const std::vector<glm::vec3>& normals,
                                             const std::vector<glm::vec4>& colors,
                                             const MaterialPtr& material) : MeshRenderable(shaderProgram, positions, normals, colors),
                                                                            m_material(material)
{
}
...
LightedMeshRenderable::LightedMeshRenderable(ShaderProgramPtr shaderProgram,
                                             ...
                                             const MaterialPtr& material) : MeshRenderable(shaderProgram, mesh_filename),
                                                                            m_material(material)
{
}

LightedMeshRenderable::LightedMeshRenderable(ShaderProgramPtr shaderProgram, bool indexed, const MaterialPtr& material) : MeshRenderable(shaderProgram, indexed), m_material(material)
{
}
