...
DirectionalLightRenderable::DirectionalLightRenderable(ShaderProgramPtr shaderProgram, DirectionalLightPtr light) : MeshRenderable(shaderProgram, false), m_light(light)
{
	// Cone
