...
PointLightRenderable::PointLightRenderable(const ShaderProgramPtr& shaderProgram, const PointLightPtr& light, unsigned int strips, unsigned int slices) : MeshRenderable(shaderProgram, true), m_light(light)
{
