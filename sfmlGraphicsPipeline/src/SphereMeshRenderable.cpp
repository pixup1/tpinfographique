...
SphereMeshRenderable::SphereMeshRenderable(ShaderProgramPtr shaderProgram, bool indexed, unsigned int strips, unsigned int slices, bool vertex_normals) : MeshRenderable(shaderProgram, indexed)
{
	if (indexed)
	{
