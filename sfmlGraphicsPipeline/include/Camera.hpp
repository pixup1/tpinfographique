...
class Camera : public KeyframedHierarchicalRenderable
{
public:
    static const glm::vec3 base_up;
    static const glm::vec3 base_forward;
    ...
    */
    ...
    enum CAMERA_BEHAVIOR {
      /** The view matrix is modified to turn and translate the camera using zqsd and arrows **/
      FIRST_PERSON_BEHAVIOR,
      /** The view matrix is modified to turn the camera around the world origin. With mouth path invariance.*/
      ARCBALL_BEHAVIOR,
      ...
      SPACESHIP_BEHAVIOR,
      /** The number of camera behaviors **/
      BEHAVIOR_NUMBER
    };
     ...
     */
    CAMERA_BEHAVIOR getBehavior() const;
    ...
    */
    void setBehavior( CAMERA_BEHAVIOR behavior);
    ...
    void mousePress( glm::vec2 );
    void mouseRelease();
    void incrementBehavior();
