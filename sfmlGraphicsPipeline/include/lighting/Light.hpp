...
class Light : public KeyframedHierarchicalRenderable
{
   public:
	 ...
	 */
	Light(const glm::vec3& ambient, const glm::vec3& diffuse, const glm::vec3& specular) : KeyframedHierarchicalRenderable(),
	                                                                                       m_ambient(ambient),
	                                                                                       m_diffuse(diffuse),
	                                                                                       m_specular(specular)
	{
...
class DirectionalLight : public Light
{
   public:
	...
	DirectionalLight(const glm::vec3& direction,
	                 ...
	                 const glm::vec3& specular) : Light(ambient, diffuse, specular), m_direction(direction)
	{
...
class PointLight : public Light
{
   public:
	...
	PointLight(const glm::vec3& position,
	           ...
	           float constant,
	           float linear,
	           float quadratic) : Light(ambient, diffuse, specular), m_position(position), m_constant(constant), m_linear(linear), m_quadratic(quadratic)
	{
...
class SpotLight : public PointLight
{
   public:
	...
	SpotLight(const glm::vec3& position, const glm::vec3& spotDirection,
	          ...
	          float innerCutOff, float outerCutOff) : PointLight(position, ambient, diffuse, specular, constant, linear, quadratic),
